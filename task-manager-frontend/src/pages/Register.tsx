    ...
    <div className="min-h-screen min-w-screen flex items-center justify-center rounded-lg bg-gray-100">
      <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
        <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
          ...
          {/* Animated error box same as login */}
          <div
          ...
          <form onSubmit={submit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  className="text-black w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent pr-12"
